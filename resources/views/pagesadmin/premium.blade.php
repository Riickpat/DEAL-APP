                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Version premium</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Tableau de bord</a></li>
                                        <li class="breadcrumb-item active">Mode payant</li>
                                    </ol>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center">
                                        <div class="row justify-content-center">
                                            <div class="col-lg-9">
                                                <h4 class="mt-4 fw-semibold">Remplissez le formulaire de vérification</h4>
                                                <p class="text-muted mt-3">Cette fonctionnalité vous permet d'obtenir les informations de votre négociateur afin
                                                    d'avoir une garantie ou une assurance sur le produit que vous échangez. En cas d'accord non respecté vous avez la possibilité de faire une reclamation grace au co trat et au formulaire que vous remplirai </p>
                                                <div class="mt-4">
                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                        Cliquer ici pour la vérification
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
