                                                    ...
                                                    <div class="table-responsive table-card">
                                                        ...
                                                        <div class="noresult" style="display: none">
                                                            <div class="text-center">
                                                                ...
                                                                <p class="text-muted mb-0">Nous avons recherché plus de 150 prospects. Nous n'avons trouvé aucun prospect pour votre recherche.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body p-5 text-center">
                                                                ...
                                                                <div class="mt-4 text-center">
                                                                    <h4 class="fs-semibold">Vous êtes sur le point de supprimer un prospect ?</h4>
                                                                    <p class="text-muted fs-14 mb-4 pt-1">La suppression de votre prospect supprimera toutes vos informations de notre base de données.</p>
                                                                    <div class="hstack gap-2 justify-content-center remove">
                                                                        ...
                                                                        <button class="btn btn-danger" id="delete-record">Oui, supprimez-le !!</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
