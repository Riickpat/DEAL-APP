                                ...
                                <div class="p-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto dropdown-tabs">
                                            <span class="badge badge-soft-light fs-13"> 4 Nouvelles</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="px-2 pt-2">
                            ...
                            <div class="tab-content position-relative" id="notificationItemsTabContent">
                                ...
                                <div class="notification-actions" id="notification-actions">
                                    <div class="d-flex text-muted justify-content-center">
                                        Select <div id="select-content" class="text-body fw-semibold px-1">0</div> Resultat <button type="button" class="btn btn-link link-danger p-0 ms-3" data-bs-toggle="modal" data-bs-target="#removeNotificationModal">Retirer</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="d-flex align-items-center">
                                ...
                                <span class="text-start ms-xl-2">
                                    <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Nom & prénom</span>
                                    <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">Administrateur</span>
                                </span>
                            </span>
                        </button>
                        <div class="dropdown-menu dropdown-menu-end">
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarEcommerce" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAuth">
                                <i class="ri-arrow-left-right-line"></i> <span data-key="t-authentication">TROCS</span>
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarCRM" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAuth">
                                <i class="ri-group-line"></i> <span data-key="t-authentication">COMPTE</span>
                            </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                                <i class="ri-apps-2-line"></i> <span data-key="t-apps">ASSURANCE</span>
                            </a>
        ...
        <div class="offcanvas-body p-0">
            <div data-simplebar class="h-100">
                <div class="p-4">
                    ...
                    <p class="text-muted">Choississez votre mise en page</p>
                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-4">
                            ...
                            <h5 class="fs-13 text-center mt-2">Deux colonne</h5>
                        </div>
                        <!-- end col -->
                        ...
                        <div class="col-4">
                            ...
                            <h5 class="fs-13 text-center mt-2">Semi-boite</h5>
                        </div>
                        <!-- end col -->
                    </div>

                    <h6 class="mt-4 mb-0 fw-semibold text-uppercase">Schéma de couleur</h6>
                    <p class="text-muted">Choississez un schéma clair ou sombre</p>
                    ...
                    <div id="sidebar-visibility">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <h5 class="fs-13 text-center mt-2">Caché</h5>
                            </div>
                        </div>
                    </div>

                    <div id="layout-width">
                        <h6 class="mt-4 mb-0 fw-semibold text-uppercase">LARGEUR DE DISPOSITION</h6>
                        <p class="text-muted">Choisissez une disposition fluide ou en boîte.</p>
...
<!-- Mirrored from themesbrand.com/velzon/html/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 13 May 2023 17:36:30 GMT -->
</html>
